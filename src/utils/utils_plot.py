...
"""
print_frequencies_to_csv(
    'data\\dml\\v0\\debug\\debug_train_meta.csv',
    ['GenusReal', 'SpeciesReal'], 
    'data\\frequencies\\gs_debug_train.csv',
    'CountGS')
"""
...
"""
print_frequencies_to_csv(
    'data\\meta-val-cal-final-old.csv', 
    ['Genus', 'Species'], 
    'data\\frequencies\\genus_species_freq_cal.csv',
    'CountGS')
"""

"""
print_frequencies_to_csv(
    'data\\all-final-metadata-old.csv', 
    ['Genus', 'Species'], 
    'data\\frequencies\\genus_species_freq.csv',
    'CountGS')
print_frequencies_to_csv(
    'data\\all-final-metadata-old.csv', 
    ['Genus'], 
    'data\\frequencies\\genus_freq.csv',
    'CountG')
print_frequencies_to_csv(
    'C:' + os.sep + 'Users' + os.sep + 'colettia' + os.sep + \
    'I-dOneNN' + os.sep + 'data' + os.sep + 'db-idone_replicas.csv',
    ['Genus', 'Species'],
    'C:' + os.sep + 'Users' + os.sep + 'colettia' + os.sep + \
    'I-dOneNN' + os.sep + 'data' + os.sep + 'genus_species_freq.csv')
"""
